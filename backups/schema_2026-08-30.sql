...
ALTER TABLE ONLY "public"."brand_deals"
    ADD CONSTRAINT "brand_deals_brand_id_fkey" FOREIGN KEY ("brand_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."brand_deals"
    ADD CONSTRAINT "brand_deals_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "public"."users"("id");
